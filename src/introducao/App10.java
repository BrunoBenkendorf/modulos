...
public class App10 {
    public static void main(String[] args) {
        ...
        ContaDeLuz conta1 = new ContaDeLuz(300f,calendario.getTime(),
        1,32,calendario.getTime(),0);

        calendario.set(2022,05,23);
        ContaDeLuz conta2 = new ContaDeLuz(400f,calendario.getTime(),
        2,42,calendario.getTime(),0);
